...
public enum DefaultMessageIDTypes {
  ...
  ID_USER_LOGIN_SUCCESS_RES,
  
  ID_USER_PLAYER_JOIN_RES,
  ID_USER_PLAYER_LEAVE_REQ,
  ID_USER_PLAYER_LEAVE_RES,
  
  ID_USER_PLAYER_READY_REQ,
  ID_USER_PLAYER_READY_RES,
  ID_USER_GAME_START_RES,
  
  ID_USER_SEND_ACTION_REQ,
  ID_USER_SEND_ACTION_RES,
  
  ID_USER_CONFIRM_ACTION_REQ,
  ID_USER_CONFIRM_ACTION_RES,
