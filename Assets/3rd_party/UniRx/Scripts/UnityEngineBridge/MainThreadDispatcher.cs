...
#pragma warning restore CS0618
        ...
        {
#if UNITY_EDITOR
            if (!Application.isPlaying) { EditorThreadDispatcher.Instance.Enqueue(action, state); return; }
        ...
        {
#if UNITY_EDITOR
            if (!Application.isPlaying) { EditorThreadDispatcher.Instance.UnsafeInvoke(action, state); return; }
#endif
