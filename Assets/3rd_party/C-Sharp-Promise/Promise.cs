...
namespace RSG
{
    ...
    public class Promise<PromisedT> : IPromise<PromisedT>, IPendingPromise<PromisedT>, IPromiseInfo
    {
        ...
        private void AddRejectHandler(Action<Exception> onRejected, IRejectable rejectable)
        {
            ...
            {
                rejectHandlers = new List<RejectHandler>(1);
            }
        ...
        private void AddResolveHandler(Action<PromisedT> onResolved, IRejectable rejectable)
        {
            ...
            {
                resolveCallbacks = new List<Action<PromisedT>>(1);
            }

            if (resolveRejectables == null)
            {
                resolveRejectables = new List<IRejectable>(1);
            }
        ...
        private void AddProgressHandler(Action<float> onProgress, IRejectable rejectable)
        {
            ...
            {
                progressHandlers = new List<ProgressHandler>(1);
            }
...
//            Argument.NotNull(() => ex);
        ...
        public IPromise<PromisedT> Catch(Func<Exception, PromisedT> onRejected)
        {
            ...
            if (IsActionHandlersResolveValid())
            {
                resolveHandler = v => resultPromise.Resolve(v);
            }
...
//            Argument.NotNull(() => transform);
        ...
        private bool IsActionHandlersResolveValid()
        {
            return CurState == PromiseState.Resolved || CurState == PromiseState.Pending;
        }
        
        private bool IsActionHandlersRejectValid()
        {
            return CurState == PromiseState.Rejected || CurState == PromiseState.Pending;
        }
        ...
        private bool IsProgressHandlersValid()
        {
            return CurState == PromiseState.Pending;
        }
